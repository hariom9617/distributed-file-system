...
| 2         | Planned  | Metadata service + chunk splitting             |
| 3         | Planned  | Multiple nodes + replication                   |
| 4         | Planned  | Heartbeat, failure detection, re-replication   |
| 5         | Planned  | Load-aware placement + rebalancer              |
| 6         | Planned  | Raft-based HA metadata                         |
| 7         | Planned  | Erasure coding                                 |
